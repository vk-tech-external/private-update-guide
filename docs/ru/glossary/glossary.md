...
|ЦОД
|Центр обработки данных — специализированное здание или помещение для размещения серверного и сетевого оборудования, оснащенное всей необходимой инфраструктурой (например: электропитание, охлаждение, сети связи и прочее).
|===
{/caption}